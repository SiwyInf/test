...
class NutritionalRecommendation:
    def __init__(self, profile: Dict[str, Any]):
        ...
        required_fields = ["gender", "age", "weight", "height", "activity_level", "goal", "allergies", "preferences"]
    ...
    def evaluate_weekly_plan(self, weekly_plan: WeeklyMealPlan) -> Dict[str, Any]:
        ...
        for day in days:
            daily_eval = self.evaluate_daily_plan(weekly_plan, day)
    ...
    def recommend_supplements(self) -> list:
        ...
        if goal == "muscle_gain":
            recommendations.extend(["Whey Protein", "Creatine", "ZMA"])
        elif goal == "weight_loss":
            recommendations.extend(["Green Tea Extract", "Fiber", "CLA"])
        elif goal == "maintenance":
        ...
        return list(set(recommendations))  # usuwa duplikaty
